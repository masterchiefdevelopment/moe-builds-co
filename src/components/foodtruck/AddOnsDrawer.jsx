...
const COMING_SOON = [
  { title: 'Live GPS Location Tracking', price: 'Ask for pricing' },
...
const ADDONS = [
  ...
  { name: 'Third-party delivery links (DoorDash, Uber Eats)', price: '$50' },
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 880, margin: '0 auto' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
            <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 'clamp(28px, 4vw, 38px)', color: C.textPrimary, letterSpacing: 1 }}>
              Upgrade Your Truck's App
            </h2>
          ...
          <div style={{ marginBottom: 36 }}>
            <span style={{
              ...
              fontWeight: 700, color: '#0d0d0d', background: C.accentColor, borderRadius: 100, padding: '5px 14px', marginBottom: 16,
            }}>🔜 Coming Soon</span>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 14 }}>
              {COMING_SOON.map(({ title, price }) => (
                <div key={title} style={{
                  ...
                  <span style={{ fontFamily: "'Inter', sans-serif", fontSize: 13, color: C.accentAmber }}>{price}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div>
            <h3 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 22, letterSpacing: 1, color: C.textPrimary, marginBottom: 14 }}>Available Add-Ons</h3>
