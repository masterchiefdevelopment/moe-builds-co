    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '80px 20px', background: C.bgPrimary }}>
      <div style={{ background: C.bgSecondary, border: `1px solid ${C.borderSubtle}`, borderRadius: 16, padding: 'clamp(28px, 5vw, 44px)', width: '100%', maxWidth: 420 }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 24, color: '#fff' }}>Create Account</div>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14, marginBottom: 20 }}>
          <input className="brb-auth-input" placeholder="Full name" value={form.fullName} onChange={e => set('fullName', e.target.value)} onKeyDown={handleKey} />
        ...
        <div style={{ textAlign: 'center', marginTop: 20, fontSize: 13, color: C.textSecondary }}>
          Already have an account? <Link to="/barber/login" style={{ color: C.accentColor, textDecoration: 'none', fontWeight: 600 }}>Sign in</Link>
        </div>
