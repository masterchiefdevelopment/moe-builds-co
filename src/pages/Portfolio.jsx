  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0A0A0A', color: '#F5F5F5', fontFamily: "'Barlow', sans-serif" }}>
      ...
      <div style={{ borderBottom: '1px solid #1a1a1a', padding: '20px 32px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div>
          <div style={{ fontFamily: "'Bebas Neue'", fontSize: '22px', letterSpacing: '4px', color: '#D4AF37' }}>MOE BUILDS CO.</div>
          <div style={{ fontFamily: "'Barlow Condensed'", fontSize: '11px', letterSpacing: '2px', color: '#444', textTransform: 'uppercase' }}>San Antonio, TX · Custom App Development</div>
        </div>
        <a href="mailto:moebuildsco@gmail.com" style={{ fontFamily: "'Barlow Condensed'", fontSize: '12px', letterSpacing: '2px', textTransform: 'uppercase', color: '#D4AF37', border: '1px solid rgba(212,175,55,0.3)', borderRadius: '4px', padding: '8px 16px', textDecoration: 'none' }}>Contact</a>
      </div>

      <div style={{ padding: 'clamp(60px, 10vw, 120px) 32px 60px', textAlign: 'center', background: 'radial-gradient(ellipse 80% 50% at 50% 0%, rgba(212,175,55,0.06) 0%, transparent 70%)' }}>
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', border: '1px solid rgba(212,175,55,0.3)', borderRadius: '100px', padding: '6px 16px', marginBottom: '24px', fontFamily: "'Barlow Condensed'", fontSize: '11px', letterSpacing: '2px', textTransform: 'uppercase', color: '#D4AF37' }}>
      ...
      <div style={{ padding: '0 32px 80px', maxWidth: '900px', margin: '0 auto' }}>
        <div style={{ fontFamily: "'Barlow Condensed'", fontSize: '11px', letterSpacing: '4px', textTransform: 'uppercase', color: '#D4AF37', textAlign: 'center', marginBottom: '40px' }}>— Live Demos —</div>
      ...
      <div style={{ borderTop: '1px solid #1a1a1a', padding: '24px 32px', display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '8px' }}>
